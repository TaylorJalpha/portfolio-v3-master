import { defineComponent, computed, ref, mergeProps, withCtx, createVNode, unref, createTextVNode, resolveDirective, useSSRContext } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderTeleport, ssrGetDirectiveProps } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue/server-renderer/index.mjs';
import { useSpring } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue-use-spring/dist/index.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-C-oUaksy.mjs';
...
import { u as useHead, a as useRouter$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function goToDetail(item) {
      ...
      const slug = ((_a = item.slug) == null ? void 0 : _a.current) || item.slug;
    ...
    function dedupeById(list) {
      ...
      return list.filter((item) => {
        var _a;
        const id = ((_a = item == null ? void 0 : item._id) == null ? void 0 : _a.replace(/^drafts\./, "")) || (item == null ? void 0 : item.id);
        if (!id) return true;
...
//# sourceMappingURL=portfolio-CHHpggkI.mjs.map
