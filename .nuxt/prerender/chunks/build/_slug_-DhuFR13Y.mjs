...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(`project-${slugParam}`, async () => {
      try {
    ...
    useHead(() => {
      var _a, _b;
      return {
        title: ((_a = data.value) == null ? void 0 : _a.title) ? `${data.value.title}` : "Project",
...
//# sourceMappingURL=_slug_-DhuFR13Y.mjs.map
