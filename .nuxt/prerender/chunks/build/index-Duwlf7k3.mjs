              ...
              createVNode("div", { class: "flex w-full h-full" }, [
                createVNode("div", { class: "flex flex-col justify-between md:max-h-[300px] gap-4" }, [
                  createVNode("div", { class: "flex flex-col h-full" }, [
                    ...
                    createVNode("p", { class: "m-0 font-light text-xl" }, " Hello, I'm Taylor J. Ferguson, certified Product Manager (PMC) with a solid foundation in web development, biz dev, and experience across multiple industries and business models: Fintech, blockchain, health-tech, and outsourced software development, most recently ")
                  ]),
...
//# sourceMappingURL=index-Duwlf7k3.mjs.map
