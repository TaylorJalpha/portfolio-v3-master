import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue/index.mjs';
import { debounce } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs';
import { b as useNuxtApp, f as asyncDataDefaults, e as createError } from './server.mjs';
...
function resolveMetaDescription(item) {
  var _a, _b;
  if (!item) return "";
  return item.meta_description || (typeof item.metadata === "string" ? item.metadata : (_a = item.metadata) == null ? void 0 : _a.description) || ((_b = item.seo) == null ? void 0 : _b.description) || item.description || "";
}
function normalizeItem(raw) {
  var _a, _b, _c, _d;
  if (!raw) return raw;
  const slug = ((_a = raw.slug) == null ? void 0 : _a.current) || raw.slug;
  if ((_b = raw == null ? void 0 : raw.pdfFile) == null ? void 0 : _b.asset) {
    raw.pdfFile.asset.url = raw.pdfFile.asset.url || raw.pdfFile.asset._ref || "";
  }
  return {
    ...raw,
    slug,
    content_type: raw._type || raw.content_type,
    featured_image_url: ((_d = (_c = raw.featuredImage) == null ? void 0 : _c.asset) == null ? void 0 : _d.url) || raw.featured_image_url,
...
const usePortfolioApi = () => {
  const fetchPortfolioItems = async (params = {}) => {
    ...
    const docs = Array.isArray(result) ? result : (result == null ? void 0 : result.data) || [];
    ...
    return {
      ...
      meta: {
        ...
        // For real total you'd run a separate count(*) query
        has_more: normalized.length === (params.per_page || 12)
      }
    };
  };
  const fetchPortfolioItem = async (idOrSlug) => {
...
export { usePortfolioApi as a, normalizeItem as n, resolveMetaDescription as r, useAsyncData as u };
//# sourceMappingURL=usePortfolioApi-0VE1fhdz.mjs.map
