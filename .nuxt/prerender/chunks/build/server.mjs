import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, useSlots, Fragment, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, createApp, reactive, toRaw, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, effectScope, isReadonly, isRef, isShallow, isReactive, watch, mergeProps, withCtx, getCurrentScope, nextTick, toValue, onScopeDispose, useSSRContext } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/radix3/dist/index.mjs';
import { c as defu } from '../nitro/nitro.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/ufo/dist/index.mjs';
import sync, { getFrameData } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/framesync/dist/es/index.mjs';
import { inertia, animate, velocityPerSecond, cubicBezier, bounceOut, bounceInOut, bounceIn, anticipate, backOut, backInOut, backIn, circOut, circInOut, circIn, easeOut, easeInOut, easeIn, linear } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/popmotion/dist/es/index.mjs';
import { number, complex, alpha, filter, px, progressPercentage, degrees, scale, color } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/style-value-types/dist/es/index.mjs';
import PortalVue from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/portal-vue/dist/portal-vue.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/tayloralphaaa/portfolio-v3-master/node_modules/vue/server-renderer/index.mjs';
...
const __nuxt_page_meta$3 = { layout: "portfolio" };
const __nuxt_page_meta$2 = { layout: "portfolio-detail" };
const __nuxt_page_meta$1 = { layout: "portfolio-detail" };
const __nuxt_page_meta = { layout: "portfolio-detail" };
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DTuEf8-6.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bkn4uvQG.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./portfolio-CHHpggkI.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./_slug_-BWYfmQxl.mjs')
  },
  {
    name: "project-slug",
    path: "/project/:slug()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_slug_-DhuFR13Y.mjs')
  },
  {
    name: "case-study-slug",
    path: "/case-study/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-DK81jbav.mjs')
  }
];
...
const portal_vue_Hxsjcd_z1kyy_LdNp52R_qMajbazLphgSHXEbtpsODg = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(PortalVue);
});
const seo_robots_rRyuRqv4eR_oNkdur9_s2txaD9C9ixPh1t3EcIpYqJg = /* @__PURE__ */ defineNuxtPlugin(() => {
  const config = /* @__PURE__ */ useRuntimeConfig();
...
const plugins = [
  ...
  seo_robots_rRyuRqv4eR_oNkdur9_s2txaD9C9ixPh1t3EcIpYqJg,
  prerender_server_sqIxOBipVr4FbVMA9kqWL0wT8FPop6sKAXLVfifsJzk
];
const layouts = {
  about: defineAsyncComponent(() => import('./about-CJALmt4P.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CTKJBVuh.mjs').then((m) => m.default || m)),
  "portfolio-detail": defineAsyncComponent(() => import('./portfolio-detail-D9WGCerL.mjs').then((m) => m.default || m)),
  portfolio: defineAsyncComponent(() => import('./portfolio-DreMjvi6.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DBYPanU_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DpCJF2lh.mjs'));
...
export { __nuxt_component_0$1 as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, createError as e, asyncDataDefaults as f, useRoute as g, navigateTo as n, resolveRouteObject as r, useHead as u };
