...
declare global {
  ...
  const { debugMarkdownContent, identifyImageReferences }: typeof import('../../utils/debugMarkdown')
  ...
  const { useMarkdownWithAssets }: typeof import('../../composables/useMarkdownWithAssets')
  const { useNuxtDevTools }: typeof import('../../node_modules/@nuxt/devtools/dist/runtime/use-nuxt-devtools')
  const { usePortableTextComponents }: typeof import('../../composables/usePortableTextComponents')
  const { usePreview }: typeof import('../../composables/usePreview')
