  ...
  const experiences = ref<ExperienceItem[]>([
    {
      ...
      description: 'Shipped an agentic pricing intelligence platform with 5 integrated product surfaces — pricing strategy engine, benchmark dashboard, plan management/CPQ, project management, and experimentation — from 0→1 in 6 months (Nuxt 3, Rails 8, PostgreSQL). Owned every phase from product discovery and Figma design through full-stack development and cloud deployment, compressing what would typically require a cross-functional team of 5+ and a 12-month development cycle into a solo AI-assisted build at a fraction of the cost.',
      ...
      achievements: [
        ...
        'Development Velocity: Leveraged AWS Kiro CLI for AI-assisted spec-driven development and deployed the full platform on AWS (EC2, RDS PostgreSQL, S3, Bedrock), cutting development and discovery costs by nearly 90%',
