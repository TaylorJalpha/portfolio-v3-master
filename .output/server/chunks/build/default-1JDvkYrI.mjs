...
import { _ as _sfc_main$3 } from './FloatingNav-DSTLn-0A.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="relative w-full min-h-screen bg-black" data-v-0743d1cc><div class="absolute inset-0 bg-gradient-to-br from-[#111111] via-[#171717] to-[#111111] opacity-50" data-v-0743d1cc></div><div class="absolute inset-0 opacity-30" data-v-0743d1cc><div class="absolute inset-0" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle at 1px 1px, rgba(255,255,255,0.1) 1px, transparent 0)", "background-size": "20px 20px" })}" data-v-0743d1cc></div></div>`);
      _push(ssrRenderComponent(_sfc_main$1$1, { number: 30 }, null, _parent));
      _push(`<main class="m-auto p-4 grid gap-2 max-w-6xl overflow-hidden relative w-full sm:p-4 sm:gap-2 md:grid-cols-2 md:gap-3 md:p-6 lg:h-screen lg:grid-cols-4 lg:gap-4 lg:max-h-[800px] z-10 text-white" data-v-0743d1cc>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><div class="flex justify-center relative z-10" data-v-0743d1cc><svg class="animate-bounce w-8 h-8 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-0743d1cc><path d="M12 5v14m7-7l-7 7-7-7" data-v-0743d1cc></path></svg></div></div><div class="text-white relative w-full z-10" data-section="experience" data-v-0743d1cc><div class="absolute inset-0 -z-10" data-v-0743d1cc>`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(`</div><div class="m-auto max-w-6xl" data-v-0743d1cc><section class="py-20 px-4 sm:px-6 lg:px-8" data-v-0743d1cc><div class="text-center mb-20" data-v-0743d1cc>`);
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-4xl md:text-5xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10 mb-6" data-v-0743d1cc${_scopeId}> My Professional Journey </h2>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed" data-v-0743d1cc${_scopeId}> Below is an timeline view of some of my experience as a product manager with core technical experience\u2013\xA0Test your assumptions, world... </p>`);
          } else {
            return [
      ...
      _push(`</div><div class="relative max-w-6xl mx-auto" data-v-0743d1cc><div class="absolute left-8 sm:left-10 lg:left-14 top-0 bottom-0 w-0.5 z-[1]" data-v-0743d1cc><div class="w-full h-full bg-gray-700/20 relative rounded-full" data-v-0743d1cc></div><div class="absolute inset-0 w-full origin-top transition-all duration-300 ease-out overflow-hidden rounded-full" style="${ssrRenderStyle({ "transform": "scaleY(0)" })}" data-v-0743d1cc><div class="w-full h-full bg-gradient-to-b from-purple-400 via-blue-500 to-cyan-400 relative rounded-full" data-v-0743d1cc><div class="absolute inset-0 bg-gradient-to-b from-purple-400/70 via-blue-500/70 to-cyan-400/70 blur-sm rounded-full" data-v-0743d1cc></div><div class="absolute w-3 h-3 bg-white rounded-full left-1/2 -translate-x-1/2 shadow-xl border-2 border-purple-300 transition-all duration-300" style="${ssrRenderStyle({ "top": "100%", "transform": "translateX(-50%) translateY(-50%)" })}" data-v-0743d1cc><div class="absolute inset-0.5 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full" data-v-0743d1cc></div></div></div></div></div><div class="space-y-12 sm:space-y-16 lg:space-y-20 relative z-[10]" data-v-0743d1cc><!--[-->`);
      ssrRenderList(experiences.value, (experience, index) => {
        _push(`<div class="${ssrRenderClass([[
          activeIndex.value >= index ? "opacity-100" : "opacity-40"
        ], "relative transition-all duration-700 ease-out timeline-item-scale"])}" data-v-0743d1cc><div class="absolute left-8 sm:left-10 lg:left-14 top-6 flex items-center z-[5]" data-v-0743d1cc><div class="${ssrRenderClass([[
          activeIndex.value >= index ? "shadow-lg scale-110" : "scale-100"
        ], "h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 rounded-full bg-white dark:bg-black flex items-center justify-center border border-neutral-300 dark:border-neutral-700 transition-all duration-500 flex-shrink-0 -translate-x-1/2"])}" data-v-0743d1cc><div class="${ssrRenderClass([[
        ...
        ], "h-3 w-3 sm:h-4 sm:w-4 lg:h-4 lg:w-4 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 transition-all duration-500"])}" data-v-0743d1cc></div></div><div class="${ssrRenderClass([[
          activeIndex.value >= index ? "scale-105" : "scale-100"
        ], "absolute right-12 sm:right-14 lg:right-16 transition-all duration-500"])}" data-v-0743d1cc><span class="${ssrRenderClass([[
        ...
        ], "inline-block px-2 py-1 sm:px-3 sm:py-1.5 text-xs sm:text-sm lg:text-base font-bold rounded-full whitespace-nowrap transition-all duration-500 bg-neutral-800 dark:bg-neutral-800 text-neutral-300 dark:text-neutral-300 border border-neutral-700 dark:border-neutral-700"])}" data-v-0743d1cc>${ssrInterpolate(experience.year)}</span></div></div><div class="ml-24 sm:ml-28 lg:ml-36 transition-all duration-700 z-[1] relative" data-v-0743d1cc><div class="bg-white/5 border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border transition-all duration-500 relative timeline-card-background max-w-3xl lg:max-w-4xl group" style="${ssrRenderStyle({ "background": "rgba(255, 255, 255, 0.08)" })}" data-v-0743d1cc><div class="absolute inset-0 rounded-xl sm:rounded-2xl opacity-30 pointer-events-none" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle at 1px 1px, rgba(255,255,255,0.1) 1px, transparent 0)", "background-size": "20px 20px" })}" data-v-0743d1cc></div><div class="mb-3 sm:mb-4 lg:mb-6 text-left" data-v-0743d1cc><h3 class="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-1 sm:mb-2 leading-tight" data-v-0743d1cc>${ssrInterpolate(experience.title)}</h3><p class="text-sm sm:text-base lg:text-lg text-[#E63946] font-semibold" data-v-0743d1cc>${ssrInterpolate(experience.company)}</p></div><p class="text-gray-300 mb-3 sm:mb-4 lg:mb-6 leading-relaxed text-sm sm:text-base text-left" data-v-0743d1cc>${ssrInterpolate(experience.description)}</p><div class="mb-3 sm:mb-4 lg:mb-6 text-left" data-v-0743d1cc><h4 class="text-xs sm:text-sm font-semibold text-white mb-2 sm:mb-3 uppercase tracking-wider" data-v-0743d1cc>Skills &amp; Technologies</h4><div class="flex flex-wrap gap-1 sm:gap-1.5 lg:gap-2 justify-start" data-v-0743d1cc><!--[-->`);
        ssrRenderList(experience.skills, (skill) => {
          _push(`<span class="px-2 sm:px-2.5 lg:px-3 py-1 sm:py-1.5 text-xs sm:text-sm rounded-md sm:rounded-lg bg-blue-500/20 text-blue-200 border border-blue-400/30 hover:bg-blue-500/30 transition-colors duration-200" data-v-0743d1cc>${ssrInterpolate(skill)}</span>`);
        });
        _push(`<!--]--></div></div><div class="text-left" data-v-0743d1cc><h4 class="text-xs sm:text-sm font-semibold text-white mb-2 sm:mb-3 lg:mb-4 uppercase tracking-wider" data-v-0743d1cc>Key Achievements</h4><ul class="space-y-1.5 sm:space-y-2 lg:space-y-3" data-v-0743d1cc><!--[-->`);
        ssrRenderList(experience.achievements, (achievement) => {
          _push(`<li class="text-xs sm:text-sm text-gray-300 flex items-start text-left" data-v-0743d1cc><span class="text-green-400 mt-0.5 sm:mt-1 flex-shrink-0 mr-2" data-v-0743d1cc>\u25B8</span><span class="leading-relaxed" data-v-0743d1cc>${ssrInterpolate(achievement)}</span></li>`);
        });
        _push(`<!--]--></ul></div></div></div></div>`);
      });
      _push(`<!--]--><div class="relative mt-12 sm:mt-16 lg:mt-20" data-v-0743d1cc><div class="absolute left-8 sm:left-10 lg:left-14 top-6 flex items-center z-[5]" data-v-0743d1cc><div class="h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 rounded-full bg-white dark:bg-black flex items-center justify-center border border-neutral-300 dark:border-neutral-700 shadow-lg flex-shrink-0 -translate-x-1/2" data-v-0743d1cc><div class="h-3 w-3 sm:h-4 sm:w-4 lg:h-4 lg:w-4 rounded-full bg-neutral-300 dark:bg-neutral-600 border border-neutral-400 dark:border-neutral-600" data-v-0743d1cc></div></div></div><div class="ml-24 sm:ml-28 lg:ml-36" data-v-0743d1cc><div class="text-gray-400 text-left" data-v-0743d1cc><p class="text-xs sm:text-sm mt-1" data-v-0743d1cc>Always learning, always growing- Keep building, fam. (Note to Self)</p></div></div></div></div></div></section></div></div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0743d1cc"]]);

export { _default as default };
//# sourceMappingURL=default-1JDvkYrI.mjs.map
