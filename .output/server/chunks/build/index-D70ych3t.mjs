...
import { ref, defineComponent, mergeProps, withCtx, createBlock, createVNode, openBlock, createTextVNode, toDisplayString, computed, createCommentVNode, Fragment, renderList, unref, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_0$1 } from './nuxt-link-DU4glTL4.mjs';
      ...
      if (_push2) {
        ...
        return [
          createVNode("div", { class: "flex flex-col gap-2" }, [
            ...
            createVNode("p", { class: "text-sm font-light" }, " I bring a well-rounded perspective to any project or role\xA0\u2013 Driving strategy, build scalable web solutions, or unlock growth opportunities through biz dev / customer acquisition "),
            createVNode("p", { class: "text-sm font-light" })
          ])
        ];
      }
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Card, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h2 class="text-xl font-bold m-0 z-20" data-v-4532d91d${_scopeId}>Portfolio</h2>`);
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<button class="animated-gradient-button group" data-v-4532d91d${_scopeId2}><span class="button-content" data-v-4532d91d${_scopeId2}><span class="button-text" data-v-4532d91d${_scopeId2}>View Portfolio</span><svg class="button-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-4532d91d${_scopeId2}><path d="M5 12h14M12 5l7 7-7 7" data-v-4532d91d${_scopeId2}></path></svg></span><div class="shine-overlay" data-v-4532d91d${_scopeId2}></div><div class="particle particle-1" data-v-4532d91d${_scopeId2}></div><div class="particle particle-2" data-v-4532d91d${_scopeId2}></div><div class="particle particle-3" data-v-4532d91d${_scopeId2}></div></button>`);
            } else {
              return [
                createVNode("button", { class: "animated-gradient-button group" }, [
                  createVNode("span", { class: "button-content" }, [
                    createVNode("span", { class: "button-text" }, "View Portfolio"),
                    (openBlock(), createBlock("svg", {
                      class: "button-arrow",
                      width: "16",
                      height: "16",
                  ...
                  createVNode("div", { class: "shine-overlay" }),
                  createVNode("div", { class: "particle particle-1" }),
                  createVNode("div", { class: "particle particle-2" }),
                  createVNode("div", { class: "particle particle-3" })
                ])
              ];
            }
          }),
        ...
        return [
          createVNode("h2", { class: "text-xl font-bold m-0 z-20" }, "Portfolio"),
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4532d91d"]]);
...
//# sourceMappingURL=index-D70ych3t.mjs.map
