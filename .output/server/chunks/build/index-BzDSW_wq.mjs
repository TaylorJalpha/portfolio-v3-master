...
import { defineComponent, ref, watch, useSSRContext, mergeProps, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, reactive, Fragment, renderList, unref, computed, resolveComponent, withModifiers, withDirectives, vModelText, createCommentVNode } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_portal, mergeProps({ to: "modals" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if (_ctx.isOpen) {
          _push2(`<div class="modal-overlay" data-v-341fb7d4${_scopeId}><div class="modal-content" data-v-341fb7d4${_scopeId}><h3 data-v-341fb7d4${_scopeId}><b data-v-341fb7d4${_scopeId}>Reach out with any questions or inquiries! \u{1F3CC}\u{1F3FC}\u200D\u2642\uFE0F</b></h3><form data-v-341fb7d4${_scopeId}><div class="form-group" data-v-341fb7d4${_scopeId}><label for="name" data-v-341fb7d4${_scopeId}>Your Name</label><input type="text" id="name"${ssrRenderAttr("value", _ctx.formData.name)} required data-v-341fb7d4${_scopeId}></div><div class="form-group" data-v-341fb7d4${_scopeId}><label for="email" data-v-341fb7d4${_scopeId}>Email:</label><input type="email" id="email"${ssrRenderAttr("value", _ctx.formData.email)} required data-v-341fb7d4${_scopeId}></div><div class="form-group" data-v-341fb7d4${_scopeId}><label for="phone" data-v-341fb7d4${_scopeId}>Phone Number:</label><input type="text" id="phone"${ssrRenderAttr("value", _ctx.formData.phone)} required data-v-341fb7d4${_scopeId}></div><div class="form-group" data-v-341fb7d4${_scopeId}><label for="message" data-v-341fb7d4${_scopeId}>Message:</label><textarea id="message" required data-v-341fb7d4${_scopeId}>${ssrInterpolate(_ctx.formData.message)}</textarea></div><button type="submit" class="submit-button" data-v-341fb7d4${_scopeId}>Submit</button><button type="button" class="close-button" data-v-341fb7d4${_scopeId}> Close </button></form></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      } else {
        return [
          _ctx.isOpen ? (openBlock(), createBlock("div", {
            key: 0,
            class: "modal-overlay",
            onClick: ($event) => _ctx.closeModal()
          }, [
            createVNode("div", {
              class: "modal-content",
              ...
              createVNode("h3", null, [
                createVNode("b", null, "Reach out with any questions or inquiries! \u{1F3CC}\u{1F3FC}\u200D\u2642\uFE0F")
              ]),
              createVNode("form", {
                onSubmit: withModifiers(($event) => _ctx.submitForm(), ["prevent"])
              }, [
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { for: "name" }, "Your Name"),
                ...
                createVNode("div", { class: "form-group" }, [
                  ...
                  withDirectives(createVNode("input", {
                    ...
                    [vModelText, _ctx.formData.email]
                  ])
                ]),
                createVNode("div", { class: "form-group" }, [
                  ...
                  withDirectives(createVNode("input", {
                    type: "text",
                    id: "phone",
                    "onUpdate:modelValue": ($event) => _ctx.formData.phone = $event,
                    required: ""
                  }, null, 8, ["onUpdate:modelValue"]), [
                    [vModelText, _ctx.formData.phone]
                  ])
                ]),
                createVNode("div", { class: "form-group" }, [
                  ...
                  withDirectives(createVNode("textarea", {
                    id: "message",
                    "onUpdate:modelValue": ($event) => _ctx.formData.message = $event,
                    required: ""
                  }, null, 8, ["onUpdate:modelValue"]), [
                    [vModelText, _ctx.formData.message]
                  ])
                ]),
                createVNode("button", {
                  type: "submit",
...
const ContactForm = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-341fb7d4"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="h-6" fill="#fff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" stroke="#fff"${_scopeId2}><g id="SVGRepo_bgCarrier" stroke-width="0"${_scopeId2}></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"${_scopeId2}></g><g id="SVGRepo_iconCarrier"${_scopeId2}><g${_scopeId2}><g${_scopeId2}><path d="M256,0C114.836,0,0,114.836,0,256s114.836,256,256,256s256-114.836,256-256S397.164,0,256,0z M256,482.286
                                            ...
                                            c9.142,0,16.571-7.429,16.571-16.571s-7.429-16.571-16.571-16.571H272.571V102.857C272.571,93.143,265.142,85.714,256,85.714z"${_scopeId2}></path></g></g></g></svg><span class="sr-only"${_scopeId2}>Expand Contact Form</span>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "h-6",
                      ...
                      createVNode("g", { id: "SVGRepo_iconCarrier" }, [
                        createVNode("g", null, [
                          createVNode("g", null, [
                            createVNode("path", { d: "M256,0C114.836,0,0,114.836,0,256s114.836,256,256,256s256-114.836,256-256S397.164,0,256,0z M256,482.286\n                                            C126.286,482.286,29.714,385.714,29.714,256S126.286,29.714,256,29.714S482.286,126.286,482.286,256S385.714,482.286,256,482.286z\n                                            M256,85.714c-9.142,0-16.571,7.429-16.571,16.571v137.143H102.857c-9.142,0-16.571,7.429-16.571,16.571\n                                            s7.429,16.571,16.571,16.571h137.143v137.143c0,9.142,7.429,16.571,16.571,16.571s16.571-7.429,16.571-16.571V272.571h137.143\n                                            c9.142,0,16.571-7.429,16.571-16.571s-7.429-16.571-16.571-16.571H272.571V102.857C272.571,93.143,265.142,85.714,256,85.714z" })
                          ])
                        ])
                      ])
                    ])),
            ...
            _push2(`<span class="hidden sm:inline bg-yellow-100 text-yellow-800 text-2xl font-large me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300 sm:text-[12px]"${_scopeId}>\u2190(WIP)</span></div></div>`);
            _push2(ssrRenderComponent(ContactForm, {
              isOpen: isContactFormOpen.value,
              "onUpdate:isOpen": ($event) => isContactFormOpen.value = $event,
              onClose: ($event) => isContactFormOpen.value = false
              ...
              createVNode("div", { class: "flex w-full h-full" }, [
                createVNode("div", { class: "flex flex-col justify-between md:max-h-[300px] gap-4" }, [
                  ...
                  createVNode("div", { class: "flex gap-4" }, [
                    ...
                    createVNode("span", { class: "hidden sm:inline bg-yellow-100 text-yellow-800 text-2xl font-large me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300 sm:text-[12px]" }, "\u2190(WIP)")
                  ])
                ]),
                createVNode(ContactForm, {
                  ...
                  "onUpdate:isOpen": ($event) => isContactFormOpen.value = $event,
                  onClose: ($event) => isContactFormOpen.value = false
                }, null, 8, ["isOpen", "onUpdate:isOpen", "onClose"]),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (current_weather.loaded) {
              _push2(`<p class="m-0 font-light text-xl text-center flex items-center justify-center"${_scopeId}><img${ssrRenderAttr("src", current_weather.now.icon)} width="50" alt="Weather Icon"${_scopeId}> ${ssrInterpolate(current_weather.now.data)}</p>`);
            } else {
              _push2(`<p class="m-0 font-light text-sm text-center flex items-center justify-center"${_scopeId}>Loading weather data... </p>`);
            }
            _push2(`</div><div class="h-full w-full absolute inset-0 -z-10"${_scopeId}><img class="world-img"${ssrRenderAttr("src", _imports_0)} alt="Picture of mountains in Los Angeles"${_scopeId}></div>`);
          } else {
            return [
      ...
      if (_push2) {
        ...
        return [
          ...
          createVNode("p", { class: "text-xs" }, [
            createTextVNode("Currently working on a few projects.."),
            createVNode("a", {
            ...
            return [
              createVNode("p", { class: "text-xs mt-3" }, [
                ...
                createVNode("a", {
                  href: "https://www.linkedin.com/in/taylor-jacob-ferguson/",
                  target: "_blank",
                  style: { "background": "-webkit-linear-gradient(rgb(133, 9, 241), rgb(209, 6, 205))", "-webkit-background-clip": "text", "color": "transparent" }
                }, " Taylor J. Ferguson.\xA9 "),
                createTextVNode(" " + toDisplayString(unref(moment)().format("Y")), 1)
              ])
            ];
          }
        }),
...
//# sourceMappingURL=index-BzDSW_wq.mjs.map
