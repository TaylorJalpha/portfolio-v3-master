        ...
        <div class="flex w-full h-full">
            <div class="flex flex-col justify-between md:max-h-[300px] gap-4">
                ...
                <div class="flex gap-4">
                    ...
                    <span class="hidden sm:inline bg-yellow-100 text-yellow-800 text-2xl font-large me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300 sm:text-[12px]">&larr;(WIP)</span>
                </div>
            </div>
