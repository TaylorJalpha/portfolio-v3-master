<template>
  ...
  >
    ...
    <button
      ...
      :aria-label="'Navigate to portfolio top'"
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
           :class="['w-4 h-4 sm:w-5 sm:h-5', 'flex-shrink-0']">
...
const navigateToExperience = () => {
  // Navigate to home page and scroll to experience section
  router.push('/').then(() => {
    // Wait a moment for the page to load, then scroll to experience
    setTimeout(() => {
